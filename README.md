...
2. Execute o script Python correspondente:
   ...
   - `python aula-08-classes/streaming_netflix.py.py`

## Pré-requisitos

- Python 3 instalado.
- Editor de texto ou IDE para visualizar o código.
...
Validação de dados de treino em um sistema de controle de exercícios, verificando nome, peso e repetições.
...
Estrutura de SRS para um app de delivery com requisitos funcionais e não funcionais.
...
Implementação de um sistema de biblioteca com classes de livro, usuário e operações de empréstimo e devolução.
...
Sistema de cadastro de usuários com validação de campos, e-mails, senhas e gerenciamento de aprovação.
...
Simulação de transferência entre contas bancárias com validações de saldo e geração de comprovante.

### Aula 08 – Diagramas de Classes

- Diagrama: [`aula-08-classes/diagrama-classes.png`](aula-08-classes/diagrama-classes.png)
- Código: [`aula-08-classes/streaming_netflix.py.py`](aula-08-classes/streaming_netflix.py.py)
- Saída: [`aula-08-classes/aula08-output.png`](aula-08-classes/aula08-output.png)

Modelo de plataforma de streaming com planos, conteúdos, filmes, séries e autenticação de usuário.
